      ...
      <div className="relative z-10 w-full max-w-[440px]">
        <div className="rounded-2xl border border-auth-border bg-auth-surface p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_20px_25px_-5px_rgba(0,0,0,0.5),0_8px_10px_-6px_rgba(0,0,0,0.5)] sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label htmlFor="password" className={`mb-2 block text-sm font-medium transition ${focusedField === "password" ? "text-auth-accent" : "text-white"}`}>New Password</label>
            ...
            <div>
              <label htmlFor="confirm" className={`mb-2 block text-sm font-medium transition ${focusedField === "confirm" ? "text-auth-accent" : "text-white"}`}>Confirm Password</label>
              <div className="relative">
                <input
                  id="confirm"
